...
```bash
$PYTHON ~/.kilocode/skills/aif-skill-generator/scripts/security-scan.py <installed-skill-path>
```
...
For each recommended skill:
  ...
  2. If found → Install: npx skills install --agent kilo <name>
...
5. Configure MCP in `.kilocode/mcp.json`
